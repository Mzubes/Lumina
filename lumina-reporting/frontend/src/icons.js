...
export const IconChevronLeft = () => (
  <svg {...base}><path d="m14.5 6-6 6 6 6" /></svg>
);

export const IconChevronRight = () => (
  <svg {...base}><path d="m9.5 6 6 6-6 6" /></svg>
);

export const IconSparkle = () => (
  <svg {...base}><path d="M12 3.5c.5 2.9 1 4.4 2 5.5 1 1 2.6 1.5 5.5 2-2.9.5-4.4 1-5.5 2-1 1-1.5 2.6-2 5.5-.5-2.9-1-4.4-2-5.5-1-1-2.6-1.5-5.5-2 2.9-.5 4.4-1 5.5-2 1-1.1 1.5-2.6 2-5.5Z" /><path d="M19 3.2c.2 1.2.4 1.8.9 2.3.5.5 1.1.7 2.3.9-1.2.2-1.8.4-2.3.9-.5.5-.7 1.1-.9 2.3-.2-1.2-.4-1.8-.9-2.3-.5-.5-1.1-.7-2.3-.9 1.2-.2 1.8-.4 2.3-.9.5-.5.7-1.1.9-2.3Z" /></svg>
);
